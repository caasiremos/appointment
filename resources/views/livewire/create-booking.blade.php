<div class="bg-green-100 w-full min-h-screen relative pt-10 bg-cover"
        ...
        <form wire:submit.prevent="createBooking">
            ...
            @if($this->hasDetailsToBook)
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-3">
                        <label for="client_telephone" class="inline-block text-white font-bold mb-2">Client
                            Telephone</label>
                        <input type="text" name="telephone" id="client_telephone" placeholder="+2567839****"
